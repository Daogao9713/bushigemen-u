...
function Admission() {
  ...
  const [major, setMajor] = useState('School of Business'); // Added setMajor back
  ...
  return (
    <div className="min-h-screen bg-slate-100 py-12 px-4 flex flex-col items-center font-sans no-print-bg">
      ...
      {/* 1. Updated Responsive Control Console */}
      <div className="text-center mb-12 max-w-2xl mx-auto w-full no-print">
        ...
        <p className="text-gray-500 text-sm mb-6 font-light">Enter details to generate your official acceptance letter.</p>
      ...
      {/* 2. Offer Letter Section with Mobile Scroll Fix */}
      {showOffer && (
            ...
            >
              ...
              <div className="relative z-10 flex justify-between items-start border-b-[3px] border-blue-900 pb-8 mb-10">
                <div className="flex items-center gap-5 text-left text-blue-900">
                  ...
                  <div>
                    <h1 className="text-3xl font-bold tracking-tighter uppercase leading-[0.9]">Bushigemen<br/>University</h1>
              ...
              <div className="relative z-10 mt-16 text-left flex items-end justify-between">
                <div className="relative inline-block">
                  ...
                  <div className="border-t-[1.5px] border-black pt-3 pr-20 relative z-10">
                    <p className="font-serif font-bold text-2xl text-slate-900 tracking-tighter">SUZUMIYA</p>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        /* Fix for scrollbar appearance on mobile */
