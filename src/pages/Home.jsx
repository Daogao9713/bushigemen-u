        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 py-20">
            ...
            <div className="flex-1 space-y-6">
              <h2 className="text-3xl font-black italic text-slate-900 dark:text-white uppercase">
                实时校区监测{' '}
                <span className="text-emerald-500 text-sm font-mono ml-2">Design by Suzumiya</span>
              </h2>
              ...
              <Link
                to="/campus"
                className="inline-block px-6 py-3 bg-emerald-600 text-white font-black text-xs rounded-full hover:bg-emerald-500 transition-all shadow-lg shadow-emerald-900/20"
              >
                进入虚拟校园
              </Link>
            </div>
            ...
            <div className="w-full max-w-[240px] md:max-w-[280px] aspect-square">
              ...
              {/* 下方可以加一行装饰性文字，显得更专业 */}
              <div className="mt-4 flex justify-between items-center px-4 font-mono">
                <span className="text-[8px] text-emerald-500/50 uppercase tracking-widest">
                  Signal: Stable
                </span>
                <span className="text-[8px] text-emerald-500/50 uppercase tracking-widest">
                  Lat: 35.69N
          ...
          {loadingNews ? (
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {latestNews.map((news, index) => {
                const displayImage =
                  news.image_url || news.image || 'https://via.placeholder.com/800x600?text=BGU+News';
